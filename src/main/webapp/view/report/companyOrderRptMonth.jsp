...
<html>
	<head>
		...
		function createRptReq(year){
			...
			$.ajax({
				url:ctx + "/companyOrderReport/getOrderMoneyYear.htm",
				data:data,
				type:"POST",
				dataType:"json",
	...
	<form method="post" action="${ctx}/companyOrderReport/delYearExcel.htm" id="delExcelfrom">
...
<div class="pageContent">
		<div id="companyRptYear" style="min-width: 310px; height: 400px;"></div>
</div>
	</body>
</html>