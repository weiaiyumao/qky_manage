		...
		<div class="pageFormContent nowrap" layoutH="56">
			<dl>
				...
				<dd>
					...
					<input  name="mSort" type="hidden"  value="${module.mSort }" />
					<input id="moduleName" class="required" name="moduleName" type="text" size="30" value="${module.moduleName }" remote="${pageContext.request.contextPath }/module/hasModuleName.htm?id=${module.id}" alt="请输入模块名称"/>
				</dd>
			</dl>
