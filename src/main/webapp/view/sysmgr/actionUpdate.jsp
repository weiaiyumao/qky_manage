		...
		<div class="pageFormContent nowrap" layoutH="56">
			<dl>
				...
				<dd>
					...
					<input  name="aSort" type="hidden"  value="${action.aSort }" />
					<input id="actionName" class="required" name="actionName" type="text" size="30" value="${action.actionName }" remote="${pageContext.request.contextPath }/action/hasActionName.htm?id=${action.id}" alt="请输入功能名称"/>
				</dd>
			</dl>
			<dl>
				<dt>功能URL：</dt>
				<dd>
					<input id="actionUrl" class="required" name="actionUrl" type="text" size="30" value="${action.actionUrl }" alt="请输入功能URL"/>
				</dd>
			</dl>
			<dl>
				<dt>所属模块：</dt>
			...
			<input type="hidden" id="moduleId" name="moduleId" value="${ action.moduleId}"  />
		<div class="formBar">
			<ul>
