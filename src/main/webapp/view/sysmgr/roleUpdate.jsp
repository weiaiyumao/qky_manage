...
<div class="pageContent">
	<form name="form1" method="post" action="${pageContext.request.contextPath }/role/mergeRole.htm" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent nowrap" layoutH="56">
			<dl>
				...
				<dd>
					...
					<input id="roleName"  class="required" name="roleName" type="text" size="30" value="${role.roleName }" remote="${pageContext.request.contextPath }/role/hasRoleRoleCodeOrRoleName.htm?id=${role.id}" alt="请输入角色名称"/>
				</dd>
			</dl>
			<dl>
				<dt>角色编码：</dt>
				<dd><input id="roleCode" class="required" name="roleCode" type="text" size="30" value="${role.roleCode }" remote="${pageContext.request.contextPath }/role/hasRoleRoleCodeOrRoleName.htm?id=${role.id}" alt="请输入角色编码"/></dd>
		...
		<input type="hidden" id="roleActions" name="roleActions" value="${role.roleActions }" />
		<div class="formBar">
			<ul>
