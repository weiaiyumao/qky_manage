...
<div class="pageContent">
	...
	<form name="Myform" method="post" action="${ctx}/law/addLaw.htm" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
		<h2 class="contentTitle">新增合同</h2>
			<dl class="nowrap">
				<dt>合同标题：</dt>
				<dd>
					<input type="text" class="required" name="title" id="title" value="" maxlength="20">
				</dd>
			</dl>
			<dl class="nowrap">
				<dt>合同类型：</dt>
				<dd>
					<select id="lawtype" class="combox required" name="lawtype" >
						...
						<c:forEach var="law" items="<%=DictionaryMap.LAWTYPE %>">
							<option value="${law.key }">${law.value}</option>
						</c:forEach>
					</select>
				</dd>
			</dl>
